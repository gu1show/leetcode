    ...
    def buddyStrings(self, s: str, goal: str) -> bool:
        ...
        if s == goal:
            ...
            for index, value in enumerate(s):
                ...
                elif (s[index] != goal[index]) and (
                    second_different_symbol_index == -1
                ):
        ...
        return (
            s[first_different_symbol_index] == goal[second_different_symbol_index]
            and goal[first_different_symbol_index] == s[second_different_symbol_index]
        )
