        ...
        for length in range(1, len(s) + 1):
            for left in range(len(s) - length + 1):
                ...
                for i in range(left, right):
                    ...
                    if j != -1:
                        segments_changing[left][right] = min(segments_changing[left][right], 1 + segments_changing[j][i] + segments_changing[i + 1][right])
                
                if j == -1: segments_changing[left][right] = 0
