...
class Solution:
    def partition(self, head: Optional[ListNode], x: int) -> Optional[ListNode]:
        ...
        iterator_head = head
        while (iterator_head != None):
            if (iterator_head.val < x) and (head_less_x == None):
                head_less_x = ListNode(iterator_head.val)
            elif (iterator_head.val < x) and (head_less_x.next == None):
            ...
            elif head_more_or_equal_x == None:
                head_more_or_equal_x = ListNode(iterator_head.val)
            elif head_more_or_equal_x.next == None:
        ...
        if head_less_x == None: return head_more_or_equal_x
        elif head_less_x.next == None: head_less_x.next = head_more_or_equal_x
        else: tail_less_x.next = head_more_or_equal_x
